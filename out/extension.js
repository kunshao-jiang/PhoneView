...
function activate(context) {
    ...
    context.subscriptions.push(vscode.window.registerWebviewViewProvider('phoneview.browser', browserViewProvider));
    // 注册预览文件命令
...
// 预览当前文件
function previewCurrentFile(context) {
    ...
    // 创建或显示WebView面板
    if (!browserPanel) {
        browserPanel = vscode.window.createWebviewPanel('phoneview', 'PhoneView 预览: ' + fileName, vscode.ViewColumn.Beside, {
            enableScripts: true,
